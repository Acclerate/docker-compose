...
```shell
# 构建镜像
docker build -t registry.cn-hangzhou.aliyuncs.com/your-name/openjdk:8-jre-alpine-skywalking-agent-9.1.0 . --no-cache
# 推送镜像
docker push registry.cn-hangzhou.aliyuncs.com/your-name/openjdk:8-jre-alpine-skywalking-agent-9.1.0
```
...
```shell
# 1、Dockerfile中引用基础镜像
# FROM registry.cn-hangzhou.aliyuncs.com/your-name/openjdk:8-jre-alpine-skywalking-agent-9.1.0
