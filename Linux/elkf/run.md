...
```
2023-01-17 14:16:59.763  INFO 29332 --- [           main] com.your-name.demo.DemoApplication       : Started DemoApplication in 1.912 seconds (JVM running for 2.415)
```
...
```
{
  ...
  "level": "INFO",
  "class": "com.your-name.demo.DemoApplication"
}
```
