...
> 部署可参考 https://your-name.blog.csdn.net/article/details/104700437
...
> mysql -hwww.your-name.com -P8066 -uroot -proot

| 名称           | 值                  |
| -------------- | ------------------- |
| 连接名         | mycat_8066          |
| 主机名或IP地址 | www.your-name.com |
| 端口           | 8066                |
| 用户名         | root                |
| 密码           | root                |
...
访问地址：[`ip地址:8082/mycat`](http://www.your-name.com:8082/mycat)
