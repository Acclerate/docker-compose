...
services:
  logstash:
    image: registry.cn-hangzhou.aliyuncs.com/your-name/logstash:7.14.1     # 原镜像`logstash:7.14.1`
...
```shell
docker run -d --name test -p 666:80 --log-driver gelf --log-opt gelf-address=udp://127.0.0.1:12201 --log-opt tag=test registry.cn-hangzhou.aliyuncs.com/your-name/test:dev
# 发起请求
...
services:
  test:
    image: registry.cn-hangzhou.aliyuncs.com/your-name/test:dev
    container_name: test
    ports:
      - "666:80"
    # 日志
