...
# 3.运行
docker run -d --name oracle18c -p 1521:1521 --restart always -v e/your-path/soft/soft-dev/Docker/data/db/oracle18c/data:/opt/oracle registry.cn-hangzhou.aliyuncs.com/zhengqing/oracle18c
